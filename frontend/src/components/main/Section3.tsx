...
const Section3 = () => {
  return (
    <div className="section3-content">
      ...
      <div className="section3-img1" data-aos="flip-right" data-aos-duration="1500"><Image1/></div>
      <div className="section3-img2" data-aos="flip-left" data-aos-duration="1500"><Image2/></div>
    </div>
  );
};
