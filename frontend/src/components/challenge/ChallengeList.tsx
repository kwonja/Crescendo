    ...
    <div className="challenge-list">
      <div className="title">SHOW YOUR CHALLENGE!!</div>
      {
          challengeLists.length === 0 ? (
            <div className='flex flex-col gap-5'><div className='flex w-full text-4xl'>아직 등록된 챌린지가 없습니다</div> <div className='flex w-full justify-center text-4xl'>지금 참여하세요😀</div></div>
          ) : (
