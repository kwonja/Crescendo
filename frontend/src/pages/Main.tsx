...
import Section1 from '../components/main/hooks/Section1';
import Section2 from '../components/main/hooks/Section2';
import Section3 from '../components/main/hooks/Section3';
import Section4 from '../components/main/hooks/Section4';
